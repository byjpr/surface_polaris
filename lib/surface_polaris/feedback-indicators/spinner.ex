defmodule SurfacePolaris.Spinner do
  ...
  defp spinnerSVGMarkup("large" = _assigns) do
    """
  ...
  defp spinnerSVGMarkup("small" = _assigns) do
    """
  ...
  def render(assigns) do
    ~F"""
      <span
        class={
          ["Polaris-Spinner"] ++ [ "Polaris-Spinner--sizeSmall": @size == "small",
          "Polaris-Spinner--sizeLarge": @size == "large"
        ] ++ @class
        }>
        {spinnerSVGMarkup(@size)}
      </span>
    """
  end
end
